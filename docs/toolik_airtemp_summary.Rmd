...
toolik_weather <- read_csv(here::here("data", "data-raw", "toolik_weather.csv"),
                           na = "#N/A")
# data.table""fread() for larger data sets
```
...
```{r}
# save in this directory, this file, with these dimensions (`here::here` specifies working directory with the help of the RProj file)
